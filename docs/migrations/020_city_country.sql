-- Migration 020: Add City and Country to Households
-- Required during signup for client location tracking.

-- ============================================
-- 1. ADD COLUMNS TO HOUSEHOLDS
-- ============================================
ALTER TABLE households ADD COLUMN IF NOT EXISTS city TEXT;
ALTER TABLE households ADD COLUMN IF NOT EXISTS country TEXT DEFAULT 'Pakistan';

COMMENT ON COLUMN households.city IS 'City where the household is located (required at signup)';
COMMENT ON COLUMN households.country IS 'Country where the household is located (required at signup)';

-- ============================================
-- 2. UPDATE ADMIN COST DASHBOARD FUNCTION
-- ============================================
